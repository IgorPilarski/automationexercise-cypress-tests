...
import contactDorm from '../../fixtures/contactFormData.json'

class ContactPage {
    completeAndConfirmFormSubmission(name?: string, email?: string, subject?: string, message?: string): void {
        ...
        cy.get('input[data-qa="subject"]').type(subject || contactDorm.subject);
        cy.get('textarea[data-qa="message"]').type(message || contactDorm.message);
